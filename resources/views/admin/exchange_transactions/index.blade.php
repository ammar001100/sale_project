...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">شاشة صرف النقدية</li>
</ol>
@endsection
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header_style">
                <h3 class="card-title card_title_center">شاشة الصرف</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div id="ajax_responce_searchDiv" class="">
                    <form role="form" action="{{ route('exchange_transactions.store') }}" method="POST" enctype="multipart/form-data" style="
                        background-color:;">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="date" id="mov_date" name="mov_date" value="{{ old('mov_date') }}" class="form-control" placeholder="ادخل تاريخ الحركة">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="money" id="money" value="{{ old('money') }}" class="form-control" placeholder="ادخل قيمة المبلغ المحصل">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="balance" id="balance" value="{{ $money * 1 }}" class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label>البيان</label>
                                    <textarea type="text" name="byan" id="byan" class="form-control">{{ old('mov_type_id','صرف نظير ') }}</textarea>
                                </div>
                            </div>
                            <div class="card_title_center">
                                <button id="add_item_card" type="submit" class="btn btn-success">صرف</button>
                            </div>
                        </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header_style">
                <h3 class="card-title card_title_center">بيانات حركة صرف النقدية</h3>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('collect_transactions.edit', $info->id) }}" class="btn btn-sm btn-warning">
                                        طباعة</a>
                                    <a href="{{ route('collect_transactions.show', $info->id) }}" data-id="{{ $info->id }}" class="btn btn-sm btn-primary">
                                        عرض</a>
                                </td>
                            </tr>
                            @endforeach
...
@endsection
@section('script')
<script src="{{ URL::asset('assets/admin/js/exchange_transactions.js') }}"></script>
<!-- Select2 -->
