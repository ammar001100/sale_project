...
@section('pageTitle')
    فئات الاصناف
    <a type="button" href="{{ route('itemcard_categories.create') }}" class="btn btn-success btn-sm"><i
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content bg-danger">
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                <form
                                                                    action="{{ route('itemcard_categories.destroy', $info->id) }}"
                                                                    method="POST">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="submit"
