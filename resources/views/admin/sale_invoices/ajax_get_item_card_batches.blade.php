<div class="form-group">
    ...
    @if (old('itemcard_batche') == '' or $errors->has('itemcard_batche'))
    <b class="start_itemcard_batche" style="color: rgb(240, 43, 17);">*</b>
    @endif
    <select class="form-control select2" name="itemcard_batche" id="itemcard_batche" style="width: 100%;">
