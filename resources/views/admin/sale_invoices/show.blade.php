            ...
            <div class="card-body card_body_style">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($data->tax_percent <= 0) لا يوجد @else بنسبة ({{ $data->tax_percent * 1 }}) % و قيمتها ({{ $data->tax_value * 1 }}) @endif </td>
                        <td class="width30">
                            تاريخ الأضافة
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <a href="{{ route('supplier_orders.edit', $data->id) }}" class="btn btn-sm btn-info"> <i class="fas fa-pencil-alt"></i></a>
                ...
                <div class="card-header card_header_style">
                    ...
                    <h3 class="card-title card_title_center">اصناف الفاتورة
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#Add_item_cards">
                ...
                <div class="card-body table-responsive p-2 card_body_style">
                    <div id="loade_item">
                        @if (isset($sale_inv_details) && $sale_inv_details->count() > 0)
                        @php
                        $i = 1;
                        @endphp
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($sale_inv_details as $info)
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <button id="delete_item_card" type="button" value="{{ $info->id }}" data-dismiss="modal" class="btn btn-outline-light">متابعة
                                                        </button>
        ...
        <div class="modal-content bg-info">
            ...
            <div class="modal-body" id="Add_item_model_body" style="background-color: white;color:black;">
                <form role="form" action="{{ route('supplier_orders.store') }}" method="POST">
                    ...
                    <input type="hidden" id="delete_item_card_url" value="{{ route('supplier_orders.ajax_delete_item_card') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="item_card_id" id="item_card_id" style="width: 100%;">
                        ...
                        <div class="col-sm-4 relatied_price_retial_counter">
                            <div class="form-group">
                                ...
                                <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="nubmer" name="quantity" id="quantity" value="" class="form-control" placeholder="ادخل الكمية المستلمة">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="text" name="total" id="total" value="0" class="form-control" placeholder="0">
                            </div>
                        </div>
                        <div class="col-sm-4 pro_date" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="date" id="pro_date" name="pro_date" value="" class="form-control" placeholder="ادخل تاريخ انتاج الصنف">
                            </div>
                        </div>
                        <div class="col-sm-4 ex_date" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="date" id="ex_date" name="ex_date" value="" class="form-control" placeholder="ادخل تاريخ اتهاء صلاحية الصنف">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 uom_price" style="display: none;">
                            <div class="form-group">
                                ...
                                <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" type="number" name="price" id="price" value="" class="form-control" placeholder="ادخل سعر الوحدة">
                            </div>
                        </div>
                    </div>
