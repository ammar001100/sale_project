        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="card-header card_header_style">
                    <h3 class="card-title card_title_center">ادخل بيانات الخزنة للتحديث</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="{{ route('admin.treasuries.update', $data->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name"value="{{ old('name', $data['name']) }}"
                                        class="form-control" placeholder="ادخل اسم الخزنة">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="is_master">
                                        <option @if (old('is_master', $data['is_master']) == 0) selected @else '' @endif value="0">
                                            فرعية
                                        </option>
                                        <option @if (old('is_master', $data['is_master']) == 1) selected @else '' @endif value="1">
                                            رئيسية
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        name="last_isal_collect"value="{{ old('last_isal_collect', $data['last_isal_collect']) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        name="last_isal_exhcange"value="{{ old('last_isal_exhcange', $data['last_isal_exhcange']) }}"
