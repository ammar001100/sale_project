    ...
    <div class="col-12">
        <div class="card p-3">
            <div class="card-header card_header_style">
                <h3 class="card-title card_title_center">اضافة عميل جديدة</h3>
            </div>
            <!-- /.card-header -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="ادخل اسم العميل">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12" style="border: solid 1px #9290e7;margin: 10px;background: #f0f0f3;">
                            <div class="form-group">
                                <img src="{{ asset('assets/admin/uploads/customers_imgs/default.png') }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                            </div>
                            <div class="form-group">
            ...
            <div class="card_title_center">
                <button id="do_add_customers" type="submit" class="btn btn-success">اضافة</button>
