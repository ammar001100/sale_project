...
@section('pageTitle')
العملاء
<a type="button" href="{{ route('customers.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i></a>
@endsection
@section('breadcrumb')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header_style">
                <h3 class="card-title card_title_center">بيانات العملاء</h3><br>
                <div class="row">
                    @if (isset($data) && $data->count() >= 1)
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="icheck-success d-inline">
                                <input type="radio" value="customer_code" name="r3" id="radio2">
                                <label for="radio2">
                                </label>
                            </div>
                            بحث برقم العميل
                            ...
                            بحث برقم حساب العميل
                        </div>
                        <input type="text" id="search_by_text" class="form-control" placeholder="ادخل رقم العميل او اسم العميل او رقم حساب العميل"><br>
                    </div>
                    <input type="hidden" id="ajax_search_url" value="{{ route('customers.ajax_search') }}">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('customers.edit', $info->id) }}" class="btn btn-sm btn-info"> <i class="fas fa-pencil-alt"></i></a>
                                        <!-- <a href="{{ route('customers.show', $info->id) }}" class="btn btn-primary btn-sm">
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content bg-default">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">تفاصيل العميل -
                                                            {{ $info->name }}</h4>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <div class="col-sm-12" style="margin: 5px;">
                                                                        <div class="form-group">
                                                                            <img src="{{ asset('assets/admin/uploads/customers_imgs/'.$info->photo) }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="modal fade" id="modal-delete{{ $info->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            هل انت متاكد من عملية الحذف العميل
                                                            <b>{{ $info->name }} </b>؟
                                                        </p>
                                                        <p>
...
@endsection
@section('script')
<script src="{{ URL::asset('assets/admin/js/customers_search.js') }}"></script>
<!-- InputMask -->
