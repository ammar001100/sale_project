...
@section('pageTitle')
فئات الموردين
<a type="button" href="{{ route('supplier_categories.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i></a>
@endsection
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item">الحسابات المالية</li>
    <li class="breadcrumb-item active">فئات الموردين</li>
</ol>
@endsection
@section('content')
<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                <td>
                                    <a href="{{ route('supplier_categories.edit', $info->id) }}" class="btn btn-sm btn-info"> <i class="fas fa-pencil-alt"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-danger">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    <form action="{{ route('supplier_categories.destroy', $info->id) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
