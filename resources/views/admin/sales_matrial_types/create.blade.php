...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.sales_matrial_types') }}">فئة الفواتير</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-3">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="{{ route('admin.sales_matrial_types.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
