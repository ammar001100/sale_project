        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="card-header card_header_style">
                    <h3 class="card-title card_title_center">ادخل البيانات لتحديثها </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="{{ route('item_cards.update', $data->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('barcode', $data->barcode) == '' or $errors->has('barcode'))
                                        <b class="start_barcode_edit" style="color: rgb(240, 43, 17);">*</b>
                                    @endif
                                    <input type="text" name="barcode" id="barcode_edit"
                                        value="{{ old('barcode', $data->barcode) }}" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('name', $data->name) == '' or $errors->has('name'))
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('item_type', $data->item_type) == '' or $errors->has('item_type'))
                                    ...
                                    <select class="custom-select" name="item_type" id="item_type">
                                        ...
                                        <option @if (old('item_type', $data->item_type) == 1) selected @else '' @endif value="1">
                                            مخزني
                                        </option>
                                        <option @if (old('item_type', $data->item_type) == 2) selected @else '' @endif value="2">
                                            استهلاكي بتاريخ صلاحية
                                        </option>
                                        <option @if (old('item_type', $data->item_type) == 3) selected @else '' @endif value="3">
                                            عهدة
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('itemcard_category_id', $data->itemcard_category_id) == '' or $errors->has('itemcard_category_id'))
                                    ...
                                    <select class="custom-select" name="itemcard_category_id" id="itemcard_category_id">
                                        ...
                                        @if (@isset($Itemcard_categories) && !@empty($Itemcard_categories))
                                            @foreach ($Itemcard_categories as $info)
                                                <option @if (old('itemcard_category_id', $data->itemcard_category_id) == $info->id) selected @else '' @endif
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('uom_id', $data->uom_id) == '' or $errors->has('uom_id'))
                                    ...
                                    <select class="custom-select" name="uom_id" id="uom_id">
                                        ...
                                        @if (@isset($uoms) && !@empty($uoms))
                                            @foreach ($uoms as $info)
                                                <option @if (old('uom_id', $data->uom_id) == $info->id) selected @else '' @endif
                                                    value="{{ $info->id }}">{{ $info->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-sm-6 relatied_parent_counter">
                                <div class="form-group">
                                    ...
                                    @if (old('does_has_retailunit', $data->does_has_retailunit) == '' or $errors->has('does_has_retailunit'))
                                    ...
                                    <select style="background: rgb(231, 206, 219);" class="custom-select"
                                        ...
                                        <option @if (old('does_has_retailunit', $data->does_has_retailunit) == 1) selected @else '' @endif value="1">
                                            نعم
                                        </option>
                                        <option @if (old('does_has_retailunit', $data->does_has_retailunit) == '0' and
                                                (old('does_has_retailunit', $data->does_has_retailunit) == '0') != '') selected  @else '' @endif value="0">
                                            لا
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6 relatied_parent_counter">
                                <div class="form-group">
                                    ...
                                    @if (old('price', $data->price) == '' or $errors->has('price'))
                            ...
                            <div class="col-sm-6 relatied_parent_counter">
                                <div class="form-group">
                                    ...
                                    @if (old('nos_gomal_price', $data->nos_gomal_price) == '' or $errors->has('nos_gomal_price'))
                                        <b class="start_nos_gomal_price" style="color: rgb(240, 43, 17);">*</b>
                                    @endif
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        style="background: rgb(201, 200, 238);" type="text" name="nos_gomal_price"
                                        id="nos_gomal_price" value="{{ old('nos_gomal_price', $data->nos_gomal_price) }}"
                            ...
                            <div class="col-sm-6 relatied_parent_counter">
                                <div class="form-group">
                                    ...
                                    @if (old('gomal_price', $data->gomal_price) == '' or $errors->has('gomal_price'))
                                        <b class="start_gomal_price" style="color: rgb(240, 43, 17);">*</b>
                                    @endif
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        style="background: rgb(201, 200, 238);" type="text" name="gomal_price"
                                        id="gomal_price" value="{{ old('gomal_price', $data->gomal_price) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6 relatied_parent_counter">
                                <div class="form-group">
                                    ...
                                    @if (old('cost_price', $data->cost_price) == '' or $errors->has('cost_price'))
                                        <b class="start_nos_gomal_price" style="color: rgb(240, 43, 17);">*</b>
                                    @endif
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        style="background: rgb(201, 200, 238);" type="text" name="cost_price"
                                        id="cost_price" value="{{ old('cost_price', $data->cost_price) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6 relatied_retial_counter"
                                @if (old('does_has_retailunit', $data->does_has_retailunit) == 1) '' @else style="display: none;" @endif>
                                <div class="form-group">
                                    ...
                                    @if (old('retail_uom_id', $data->retail_uom_id) == '' or $errors->has('retail_uom_id'))
                                    ...
                                    <select style="background: rgb(206, 231, 206);" class="custom-select"
                                        ...
                                        @if (@isset($retail_uoms) && !@empty($retail_uoms))
                                            @foreach ($retail_uoms as $info)
                                                <option @if (old('retail_uom_id', $data->retail_uom_id) == $info->id) selected @else '' @endif
                                                    value="{{ $info->id }}">{{ $info->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-sm-6 relatied_price_retial_counter"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (old('retail_uom_quntToparent', $data->retail_uom_quntToparent) == '' or $errors->has('retail_uom_quntToparent'))
                            ...
                            <div class="col-sm-6 relatied_price_retial_counter"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (old('price_retail', $data->price_retail) == '' or $errors->has('price_retail'))
                                        <b class="start_price_retail" style="color: rgb(240, 43, 17);">*</b>
                                    @endif
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        style="background: rgb(226, 238, 200);" type="text" name="price_retail"
                                        id="price_retail" value="{{ old('price_retail', $data->price_retail) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6 relatied_price_retial_counter"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (old('nos_gomal_price_retail', $data->nos_gomal_price_retail) == '' or $errors->has('nos_gomal_price_retail'))
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        ...
                                        value="{{ old('nos_gomal_price_retail', $data->nos_gomal_price_retail) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6 relatied_price_retial_counter"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (old('gomal_price_retail', $data->gomal_price_retail) == '' or $errors->has('gomal_price_retail'))
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        ...
                                        id="gomal_price_retail"
                                        value="{{ old('gomal_price_retail', $data->gomal_price_retail) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6 relatied_price_retial_counter"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (old('cost_price_retail', $data->cost_price_retail) == '' or $errors->has('cost_price_retail'))
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                        ...
                                        value="{{ old('cost_price_retail', $data->cost_price_retail) }}"
                                        class="form-control" placeholder="ادخل السعر">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('item_card_id', $data->item_card_id) == '' or $errors->has('item_card_id'))
                                    ...
                                    <select class="custom-select" name="item_card_id" id="item_card_id">
                                        ...
                                        @if (@isset($child_item_cards) && !@empty($child_item_cards))
                                            @foreach ($child_item_cards as $info)
                                                <option @if (old('item_card_id', $data->item_card_id) == $info->id) selected @else '' @endif
                                                    value="{{ $info->id }}">{{ $info->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('has_fixced_price', $data->has_fixced_price) == '' or $errors->has('has_fixced_price'))
                                    ...
                                    <select class="custom-select" name="has_fixced_price" id="has_fixced_price">
                                        ...
                                        <option @if (old('has_fixced_price', $data->has_fixced_price) == '1') selected  @else  '' @endif
                                            value="1">
                                            نعم ثابت ولا يتغير بالفواتير
                                        </option>
                                        <option @if (old('has_fixced_price', $data->has_fixced_price) == '0' and
                                                (old('has_fixced_price', $data->has_fixced_price) == '0') != '') selected  @else '' @endif
                                            value="0">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('active', $data->active) == '' or $errors->has('active'))
                                    ...
                                    <select class="custom-select" name="active" id="active">
                                        ...
                                        <option @if (old('active', $data->active) == '0' and (old('active', $data->active) == '0') != '') selected  @else '' @endif
                                            value="0">
                                            غير مفعل
                                        </option>
                                    </select>
                            ...
                            <div class="col-sm-12" style="border: solid 1px #9290e7;margin: 10px;background: #f0f0f3;">
                                <div class="form-group">
                                    <img src="{{ asset('assets/admin/uploads/item_cards_imgs/' . $data->photo) }}"
                ...
                <div class="card_title_center">
                    <button id="do_add_item_card" type="submit" class="btn btn-success">تحديث</button>
                    <a href="{{ route('item_cards.edit', $data->id) }}" type="button" class="btn btn-danger">الغاء</a>
                </div>
            </div>
            </form>
        </div>
