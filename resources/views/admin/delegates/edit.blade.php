...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ route('suppliers.index') }}">مورد</a></li>
        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="card-header card_header_style">
                    <h3 class="card-title card_title_center">تعديل مورد</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @if (old('supplier_category_id', $data->supplier_category_id) == '' or
                                            $errors->has('supplier_category_id', $data->supplier_category_id))
                                    ...
                                    <select class="custom-select" name="supplier_category_id" id="supplier_category_id">
                                        ...
                                        @if (@isset($supplier_category) && !@empty($supplier_category))
                                            @foreach ($supplier_category as $info)
                                                <option @if (old('supplier_category_id', $data->supplier_category_id) == $info->id) selected @else '' @endif
                            ...
                            <div class="col-sm-12" style="border: solid 1px #9290e7;margin: 10px;background: #f0f0f3;">
                                <div class="form-group">
                                    <img src="{{ asset('assets/admin/uploads/suppliers_imgs/' . $data->photo) }}"
