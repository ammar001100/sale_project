...
<div class="row">
    <div class="col-12">
        <div class="card p-3">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form role="form" action="{{ route('delegates.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="ادخل اسم المندوب">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>فئة المندوب</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @endif
                                <input type="address" name="address" id="address" value="{{ old('address') }}" class="form-control" placeholder="ادخل عنوان العميل">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="form-control" placeholder="ادخل رقم هاتف العميل">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12" style="border: solid 1px #9290e7;margin: 10px;background: #f0f0f3;">
                            <div class="form-group">
                                <img src="{{ asset('assets/admin/uploads/delegates_imgs/default.png') }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                            </div>
                            <div class="form-group">
            ...
            <div class="card_title_center">
                <button id="do_add_delegates" type="submit" class="btn btn-success">اضافة</button>
                <a href="{{ route('delegates.index') }}" type="button" class="btn btn-danger">الغاء</a>
            </div>
        </div>
        </form>
    </div>
...
<script src="{{ URL::asset('assets/admin/js/delegates_validation.js') }}"></script>
<script src="{{ URL::asset('assets/admin/js/delegates.js') }}"></script>
