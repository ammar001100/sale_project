        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="card-header card_header_style">
                    <h3 class="card-title card_title_center">اضافة مخزن جديدة</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="{{ route('admin.stores.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
