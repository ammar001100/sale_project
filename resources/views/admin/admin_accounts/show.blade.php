                ...
                <div class="card-body card_body_style">
                    @if (isset($data) && $data->count() > 0)
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin_accounts.edit', $data->id) }}" class="btn btn-sm btn-info"><i
                        ...
                        <div class="card-header card_header_style">
                            <h3 class="card-title card_title_center">الصلاحيات الخاصة للمستخدم
                                ({{ $data->name }}) <a type="button"
                                    href="{{ route('admin_accounts.add_treasury', $data->id) }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content bg-danger">
                                                                    ...
                                                                    <div class="modal-footer justify-content-between">
                                                                        <a href="{{ route('admin_accounts.delete_treasury', $info->id) }}"
                                                                            type="button"
